...
export class ProjectInit1674138420718 implements MigrationInterface {
    name = 'ProjectInit1674138420718'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mnt_modules" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying(250), "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_84ffb8aebdb402d144f29bee0f9" PRIMARY KEY ("id"))`);
