...
export class CreateTablesInit1669918625885 implements MigrationInterface {
    name = 'CreateTablesInit1669918625885'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mnt_users" ("id" SERIAL NOT NULL, "email" character varying(320) NOT NULL, "password" text NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "is_verified" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_at" TIMESTAMP WITH TIME ZONE, "id_profile" integer, CONSTRAINT "UQ_1e617ed0ca179d432721034ef1a" UNIQUE ("email"), CONSTRAINT "PK_1472534d7931b53554745135d16" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "mnt_rols" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_7df04d930b65ddaeee745d876d7" UNIQUE ("name"), CONSTRAINT "PK_341e94bff374ded32c9a74b0112" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "mnt_modules" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying(250), "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_84ffb8aebdb402d144f29bee0f9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "mnt_profiles" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "update_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "delete_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_5c5f854a30cc90bf2965f27cd1b" PRIMARY KEY ("id"))`);
