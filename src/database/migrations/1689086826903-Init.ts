...
export class Init1689086826903 implements MigrationInterface {
    name = 'Init1689086826903'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "mnt_refresh_token" ("id" SERIAL NOT NULL, "refresh_token" text NOT NULL, "date_valid" TIMESTAMP WITH TIME ZONE NOT NULL, "active" boolean NOT NULL DEFAULT false, "id_user" integer, CONSTRAINT "PK_f4bad54767e6bcdd975190e853b" PRIMARY KEY ("id"))`);
